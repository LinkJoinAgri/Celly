...
extension UITableView {
    ...
    public func registerClass<T: UITableViewCell & Reusable>(cellType: T.Type) {
        register(cellType, forCellReuseIdentifier: cellType.reuseIdentifier)
    }
    
    public func registerNib<T: UITableViewCell & NibReusable>(cellType: T.Type) {
        register(cellType.nib, forCellReuseIdentifier: cellType.reuseIdentifier)
    }
    
    public func registerClass<T: UITableViewHeaderFooterView & Reusable>(headerFooterViewType: T.Type) {
        register(
    ...
    public func registerNib<T: UITableViewHeaderFooterView & NibReusable>(headerFooterViewType: T.Type) {
        register(
