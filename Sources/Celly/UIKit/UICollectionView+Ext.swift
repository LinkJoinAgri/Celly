...
extension UICollectionView {
    ...
    public func registerClass<T: UICollectionViewCell & Reusable>(cellType: T.Type) {
        register(cellType, forCellWithReuseIdentifier: cellType.reuseIdentifier)
    }
    
    public func registerNib<T: UICollectionViewCell & NibReusable>(cellType: T.Type) {
        register(cellType.nib, forCellWithReuseIdentifier: cellType.reuseIdentifier)
    }
    
    public func registerClass<T: UICollectionReusableView & Reusable>(supplementaryViewType: T.Type, kind: String) {
        register(
    ...
    public func registerNib<T: UICollectionReusableView & NibReusable>(supplementaryViewType: T.Type, kind: String) {
        register(
