...
public protocol NibContentLoadable: NibProvider {
    
}

#if os(macOS)

extension NibContentLoadable where Self: NSView {
...
extension NibContentLoadable where Self: UIView {
